...
namespace StaffManager.Framework.Dapper
{
    public class DapperRepository
    {
        ...
        /// <returns></returns>
        public static List<T> Query<T>(string sql, object param,bool type=true)
        {
            using (MySqlConnection conn = DapperFactory.CreateMySqlConnection(type))
            {
        ...
        /// <returns></returns>
        public static T QuerySingle<T>(string sql, object param, bool type = true)
        {
            T t;
        ...
        public static bool Execute<T>(List<T> list, string sql)
        {
            var result = -1;
